...
export const services = [
  {
    ...
    description: 'Fast, minimal, and SEO-friendly websites and themes built with Astro and TypeScript.',
    detailedDescription: 'I build static-first websites using Astro and TypeScript. Focus is on clean code, fast load times, and easy maintenance without bloated framework overhead.',
    features: ['Astro & TypeScript implementation', 'Clean semantic HTML & CSS', 'Responsive UI components', 'Headless CMS integration'],
  ...
  },
  {
    ...
    description: 'Vulnerability assessments and security reviews for web applications and Linux infrastructure.',
    detailedDescription: 'Hands-on review of web applications and servers to uncover vulnerabilities, misconfigurations, and attack surface risks before attackers do.',
  ...
  {
    title: 'Data Pipelines & Databases',
    slug: 'data-engineering',
    description: 'Automated ETL pipelines, data models, and database setups for clean reporting and analytics.',
    detailedDescription: 'I write ETL pipelines in Python and SQL, design relational schemas, and hook up data warehouses to dashboards without messy manual exports.',
    features: ['ETL pipeline automation (Python, SQL)', 'Relational database schema optimization', 'BI dashboard & warehouse integration', 'Data cleaning and scheduled transformations'],
  ...
  },
  {
    ...
    slug: 'ai-automation',
    description: 'Custom AI agents, LLM integrations, and scripts to automate repetitive workflows.',
    detailedDescription: 'I connect LLM APIs and internal services to automate repetitive data entry, document processing, and operational handoffs with clear human oversight.',
    features: ['Custom AI agent workflows', 'API and webhook integrations', 'Automated document processing', 'Scheduled data synchronization'],
  ...
  },
  {
    ...
    description: 'Chrome and Firefox extensions for workflow shortcuts, page customization, and data extraction.',
    detailedDescription: 'TypeScript browser extensions built with Manifest V3 for DOM automation, workflow shortcuts, content filtering, and local data processing.',
    features: ['Manifest V3 Chrome & Firefox extensions', 'DOM automation & scraping', 'Content filtering and productivity tools', 'Store submission and maintenance'],
  ...
  },
  {
    ...
    slug: 'it-operations',
    description: 'Linux VPS setups, Docker deployments, Nginx reverse proxies, and corporate email authentication.',
    detailedDescription: 'Hands-on server management: provisioning Linux VPS instances, running Docker containers, setting up SSL and Nginx, configuring DNS records (SPF, DKIM, DMARC), and automated backups.',
    features: ['Linux VPS setup (Hetzner, DigitalOcean)', 'Docker & Nginx reverse proxies', 'Domain DNS, SPF, DKIM, and DMARC', 'Automated backups and health alerts'],
...
export const projects: ProjectEntry[] = [
  ...
  {
    name: 'SlowLiv',
    domain: 'Sustainable Agribusiness',
    category: 'Marketplace',
    filterCategory: 'commerce',
    description: 'Multi-vendor marketplace for fresh agricultural produce, hydroponics, and certified local food products.',
    details: 'A sustainable commerce platform empowering retiree entrepreneurs (mitra purnabakti) and local UMKM producers. Features standardized P-IRT and Halal-certified product discovery, multi-origin courier logistics, store pickup with 4-digit PIN verification, an interactive Green Map for partner farm discovery, and an integrated Asisten AI shopping companion.',
    stack: ['Astro', 'TypeScript', 'Tailwind CSS', 'Cloudflare', 'AI Integration'],
    outcome: 'Multi-vendor marketplace, store pickup PIN verification, interactive Green Map, AI assistant',
    href: 'https://slowliv.com',
    image: 'slowliv-com.png',
    size: 'large',
    featured: true,
  },
  {
  ...
  {
    name: 'WINCIFDON',
    domain: 'Family Digital Hub',
    category: 'Digital Ecosystem',
    filterCategory: 'other',
    description: 'Unified digital ecosystem and multi-venture portal connecting family initiatives, media, and tech research.',
    details: 'A centralized digital ecosystem platform designed and developed to unify family ventures across Islamic educational dakwah (DakwaBilHal), healthy living advocacy (PejuangSerat), financial literacy (Mindset Milyader), and technology research (Farros Tech / Red Team). Features headless Decap CMS integration for modular content authoring.',
    stack: ['Astro', 'TypeScript', 'Tailwind CSS', 'Decap CMS'],
    outcome: 'Multi-venture portal, CMS content architecture, family identity hub',
    href: 'https://wincifdon.com',
